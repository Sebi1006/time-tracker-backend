...
echo "Step1: Create tenant_master table in DynamoDB for tenant resources"
...
echo "Step2: Create user pool for free subscription tenants"
...
echo "Step3: Create groups in user pool"
...
echo "Step4: Create app client in user pool"
...
echo "Step5: Write tenant resources of free tenant in tenant_master DB"
aws dynamodb put-item --table-name tenant_master --item file://item.json

echo "Step6: Create Amplify Frontend"
