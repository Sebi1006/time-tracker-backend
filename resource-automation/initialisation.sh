...
echo "Step 1: Create tenant_master table in DynamoDB for tenant resources"
...
echo "Step 2: Create user pool for free subscription tenants"
...
echo "Step 3: Create groups in user pool"
...
echo "Step 4: Create app client in user pool"
...
echo "Step 5: Write tenant resources of free tenant in tenant_master table"
aws dynamodb put-item --table-name tenant_master --item file://item.json

echo "Step 6: Create Amplify frontend"
